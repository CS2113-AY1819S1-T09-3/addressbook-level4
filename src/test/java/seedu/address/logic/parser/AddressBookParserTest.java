...
public class AddressBookParserTest {
    ...
    @Test
    public void parseCommand_Eventslist() throws Exception {
        assertTrue(parser.parseCommand(ListEventCommand.COMMAND_WORD) instanceof  ListEventCommand);
        assertTrue(parser.parseCommand(ListEventCommand.COMMAND_WORD + "2") instanceof  ListEventCommand);
    }
    @Test
    public void parseCommand_EventslistAlias() throws Exception {
        assertTrue(parser.parseCommand(ListEventCommand.COMMAND_ALIAS) instanceof  ListEventCommand);
        assertTrue(parser.parseCommand(ListEventCommand.COMMAND_ALIAS + "2") instanceof ListEventCommand);
    }
